           ...
           @include('admin.sidebar')
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    @include('admin.live_data')
                    @include('admin.insert_code')
                    @include('admin.vCode')
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2016-2017 <a href="#">Mizan</a>.</strong> All rights reserved. <i class="fa fa-heart color-green"></i>
            </footer>
        </div>
        <!-- ./wrapper -->
        <!-- Start Core Plugins
